...
questions = {
    ...
    'normal': [
        ...
        {'question': 'Какой океан является самым глубоким?', 'answer': 'Тихий океан,Тихий'}
    ],
    'hard': [
...
def send_welcome(message):
    bot.reply_to(message,
                 "Привет! Хочешь сыграть в викторину"
                 "(отвечать на все вопросы с заглавной буквы)? Выбери уровень сложности:\n/level_easy\n/level_normal\n/level_hard")
